...
module ActivityTypes =
    ...
    /// <summary>
    /// Represents objects such as news articles, knowledge base entries, or other similar construct. Such objects generally
    /// consist of paragraphs of text, in some cases incorporating embedded media such as photos and inline hyperlinks to other
    /// resources.
    /// </summary>
    ...
    /// <summary>
    /// An assessment is an activity that determines a learner's mastery of a particular subject area. An assessment typically
    ...
    /// <summary>
    /// Represents audio content of any kind. Objects of this type MAY contain an additional property as specified in Section
    /// 3.1.
    /// </summary>
    ...
    /// <summary>
    /// Objects of this type are used to carry arbitrary Base64-encoded binary data within an Activity Stream object. It is
    /// primarily intended to attach binary data to other types of objects through the use of the attachments property. Objects
    /// of this type will contain the additional properties specified in Section 3.2.This activity type is included for data
    /// conversion with Activity Streams, it's not recommended for use in new Tin Can statements.
    /// </summary>
    ...
    /// <summary>
    /// A regularly updated website or web page, typically one authored by an individual or small group, that is written in an
    ...
    /// <summary>
    /// A book, generally paper, but could also be an ebook. The Activity's ID will often include an ISBN though it is not
    /// required. The Definition can likely leverage the ISBN extension, 'http://id.tincanapi.com/extension/isbn', if known.
    /// </summary>
    ...
    /// <summary>
    /// Represents a pointer to some URL -- typically a web page. In most cases, bookmarks are specific to a given user and
    /// contain metadata chosen by that user. Bookmark Objects are similar in principle to the concept of bookmarks or favorites
    /// in a web browser. A bookmark represents a pointer to the URL, not the URL or the associated resource itself. Objects of
    /// this type SHOULD contain an additional targetUrl property whose value is a String containing the IRI of the target of
    /// the bookmark.
    /// </summary>
    ...
    /// <summary>
    /// Activity generally used in the "category" Context Activities lists to mark a statement as being related to a particular
    /// subject area. Distinct from tag in that it is used in conjunction with Subcategory to imply a hierarchy of
    /// categorization. 
    /// </summary>
    ...
    /// <summary>
    /// Create a Statement to represent that the educator or caretaker had to change the child’s diapers. This action is
    /// generally associated to the statement ece:defecated or ece:urinated indicating the cause of the diaper change.
    /// Nonetheless, one can record the Statement without indicating the context to keep a record of the number of diaper
    ...
    /// <summary>
    /// A message sent or received within the context of an instant chat platform such as Slack. The id of this activity should
    /// uniquely identify the particular chat message.
    /// </summary>
    ...
    /// <summary>
    /// Represents a generic collection of objects of any type. This object type can be used, for instance, to represent a
    /// collection of files like a folder; a collection of photos like an album; and so forth. Objects of this type MAY contain
    /// an additional objectTypes property whose value is an Array of Strings specifying the expected objectType of objects
    /// contained within the collection.This activity type is included for data conversion with Activity Streams, it's not
    /// recommended for use in new Tin Can statements.
    /// </summary>
    ...
    /// <summary>
    /// Represents a textual response to another object. Objects of this type MAY contain an additional inReplyTo property
    /// whose value is an Array of one or more other Activity Stream Objects for which the object is to be considered a
    /// response.
    /// </summary>
    ...
    /// <summary>
    /// A space on a social platform (or other platform with social features) for a community to communicate, share and
    /// collaborate. For example a Google Plus Community, a Facebook Group, a Jive Space or a Pathgather Gathering. 
    /// </summary>
    ...
    /// <summary>
    /// A course represents an entire "content package" worth of material.  The largest level of granularity.  Unless flat, a
    /// course consists of multiple modules.  A course is not content.
    /// </summary>
    ...
    /// <summary>
    /// An organisation within the Curatr platform. This is a collection of learners and courses. 
    /// </summary>
    ...
    /// <summary>
    /// An electronic document of the type produced by office productivity software such as a word processing document,
    ...
    /// <summary>
    /// Represents an event that occurs at a certain location during a particular period of time. Objects of this type MAY
    /// contain the additional properties specified in Section 3.3.
    /// </summary>
    ...
    /// <summary>
    /// Represents any form of document or file. Objects of this type MAY contain an additional fileUrl property whose value a
    /// dereferenceable IRI that can be used to retrieve the file; and an additional mimeType property whose value is the MIME
    ...
    /// <summary>
    /// Indicates an annotation made to a document of the 'freetext' form. This is a string of text written direction onto the
    /// document at a specified location. Freetext annotations can be added anywhere on the page. Unlike note annotations, they
    /// have no border or background.
    /// </summary>
    ...
    /// <summary>
    /// A level of a game or gamifed learning platform. 
    /// </summary>
    ...
    /// <summary>
    /// A goal is something that the actor wants to achieve, the purpose of doing a task or group of tasks. It can have
    ...
    /// <summary>
    /// Represents a grade given or received within a particular context, for example ‘distinction’ within XYZ music test or
    /// ‘A’ for ABC qualification.
    /// </summary>
    ...
    /// <summary>
    /// An annotation of the 'highlight' type. Highlights are used to mark strings of text in a document with a color. This
    /// activity type should only be used for highlighted text and not for highlighted images or other elements. 
    /// </summary>
    ...
    /// <summary>
    /// Represents a graphical image. Objects of this type MAY contain an additional fullImage property whose value is an
    /// Activity Streams Media Link to a "full-sized" representation of the image.
    /// </summary>
    ...
    /// <summary>
    /// An interaction is typically a part of a larger activity (such as assessment or simulation) and refers to a control to
    /// which a learner provides input.  An interaction can be either an asset or function independently.
    /// </summary>
    ...
    /// <summary>
    /// Represents a report about a problem or situation that needs to be resolved. For instance, the issue object can be used
    /// to represent reports detailing software defects, or reports of acceptable use violations, and so forth. Objects of this
    /// type MAY contain the additional properties specified in Section 3.4.
    /// </summary>
    ...
    /// <summary>
    /// The title of a person's job. May be used with the http://id.tincanapi.com/verb/was-assigned-job-title verb. 
    /// </summary>
    ...
    /// <summary>
    /// Activity representing a statement generated by a course originally implemented in a legacy learning standard such as
    /// SCORM 1.2, 2004, or AICC.
    /// </summary>
    ...
    /// <summary>
    /// A link is simply a means of expressing a link to another resource within, or external to, an activity.  A link is not
    /// synonymous with launching another resource and should be considered external to the current resource.  Links are not
    /// learning content, nor SCOs.  If a link is intended for this purpose, it should be re-categorized.
    /// </summary>
    ...
    /// <summary>
    /// Learning Management System. At it's core, a platform used to launch and track learning experiences. Many LMS also have
    ...
    /// <summary>
    /// Media refers to text, audio, or video used to convey information. Media can be consumed (tracked: completed), but
    /// doesn't have an interactive component that may result in a score, success, or failure.
    /// </summary>
    ...
    /// <summary>
    /// A module represents any "content aggregation" at least one level below the course level.  Modules of modules can exist
    /// for layering purposes.  Modules are not content.  Modules are one level up from all content.
    /// </summary>
    ...
    /// <summary>
    /// Represents a short-form text message. This object is intended primarily for use in "micro-blogging" scenarios and in
    /// systems where users are invited to publish short, often plain-text messages whose useful lifespan is generally shorter
    /// than that of an article of weblog entry. A note is similar in structure to an article, but typically does not have a
    /// title or distinct paragraphs and tends to be much shorter in length.
    /// </summary>
    ...
    /// <summary>
    /// Indicates an annotation made to a document of the 'note' form. This is a string of text appended to the document at a
    /// specified location. Note annotations can be added anywhere on the page. This activity type should not be used for other
    /// types of note that are not annotations to a document. 
    /// </summary>
    ...
    /// <summary>
    /// An objective determines whether competency has been achieved in a desired area.  Objectives typically are associated
    /// with questions and assessments.  Objectives are not learning content and cannot be SCOs.
    /// </summary>
    ...
    /// <summary>
    /// A virtual lab built upon request which is used to prepare for a certification or elevated permissions.
    /// </summary>
    ...
    /// <summary>
    /// An organization such as a company, which may hire, fire and promote employees.
    /// </summary>
    ...
    /// <summary>
    /// Represents an area, typically a web page, that is representative of, and generally managed by a particular entity. Such
    /// areas are usually dedicated to displaying descriptive information about the entity and showcasing recent content such as
    /// articles, photographs and videos. Most social networking applications, for example, provide individual users with their
    /// own dedicated "profile" pages. Several allow similar types of pages to be created for commercial entities, organizations
    /// or events. While the specific details of how pages are implemented, their characteristics and use may vary, the one
    /// unifying property is that they are typically "owned" by a single entity that is represented by the content provided by
    /// the page itself.
    /// </summary>
    ...
    /// <summary>
    /// A distinct division of written or printed matter that begins on a new, usually indented line, consists of one or more
    /// sentences, and typically deals with a single thought or topic or quotes one speaker's continuous words.
    /// </summary>
    ...
    /// <summary>
    /// A performance is an attempted task or series of tasks within a particular context.  Tasks would likely take on the form
    /// of interactions, or the performance could be self-contained content.
    /// </summary>
    ...
    /// <summary>
    /// Represents an individual person.This activity type is included for data conversion with Activity Streams, it's not
    /// recommended for use in new Tin Can statements. Agent should be used instead of person.
    /// </summary>
    ...
    /// <summary>
    /// Represents a physical location. Locations can be represented using geographic coordinates, a physical address, a
    /// free-form location name, or any combination of these. Objects of this type MAY contain the additional properties
    ...
    /// <summary>
    /// A collection of resources or experiences grouped together as recommended resources by an individual. Generally used for
    /// informally curated resources rather than official collections such as an LMS course.  
    /// </summary>
    ...
    /// <summary>
    /// Represents any form of process. For instance, a long-running task that is started and expected to continue operating
    ...
    /// <summary>
    /// Represents a commercial good or service. Objects of this type MAY contain an additional fullImage property whose value
    /// is an Activity Streams Media Link to an image resource representative of the product.
    /// </summary>
    ...
    /// <summary>
    /// Represents a question or a poll. Objects of this type MAY contain an additional options property whose value is an
    /// Array of possible answers to the question in the form of Activity Stream objects of any type.
    /// </summary>
    let Question = ActivityDefinition(LanguageMap(LanguageTag.EnglishUS, "question"),
                                      LanguageMap(LanguageTag.EnglishUS, "Represents a question or a poll. Objects of this type MAY contain an additional options property whose value is an Array of possible answers to the question in the form of Activity Stream objects of any type."),
                                      Uri("http://activitystrea.ms/schema/1.0/question"))

    /// <summary>
    /// A recipe is an Activity that is used in the Context Activities "category" property of a Statement to indicate that the
    /// Statement is part of a pre-defined model that can be expected to have certain properties, object identifiers, or
    /// structure. Statements adhering to a particular recipe are recognizable by reporting systems for the purposes of testing,
    ...
    /// <summary>
    /// A remote lab experimentation is the act of experimenting with a real lab apparatus through the Internet.
    /// </summary>
    ...
    /// <summary>
    /// A research report from a government organization or other authoritative body giving information or proposals on an
    /// issue.
    /// </summary>
    ...
    /// <summary>
    /// A resource is a generic item that the actor may use for something. It could be a video, a text article, a device, etc.
    /// However, it is recommended to use a more specific activity type like those mentioned.
    /// </summary>
    ...
    /// <summary>
    /// Represents a primarily prose-based commentary on another object. Objects of this type MAY contain a rating property as
    ...
    /// <summary>
    /// Scenario - scenario based learning - is delivering the content embedded within a story or scenario rather than just
    /// pushing the content straight out. Usually a story or a situation is presented to ask for learner's action, feedback or
    /// branching follow. In this way learners see how the learning is applied to job environments or real world problems. 
    /// </summary>
    ...
    /// <summary>
    /// A school task performed by a student to satisfy the teacher. Examples are assessments, assigned reading, practice
    /// exercises, watch video, etc.
    /// </summary>
    ...
    /// <summary>
    /// A section of an application or platform. For sales performance app might be divided into client demo, learning
    /// materials and reference documents sections. 
    /// </summary>
    ...
    /// <summary>
    /// A feature that enables system administrators to restrict system access and manage access on a per-user or per-group
    /// basis.
    /// </summary>
    ...
    /// Examples of such objects include websites, businesses, etc.
    /// </summary>
    ...
    /// <summary>
    /// It is a collection of items of the same activity type, for example, a collection of games. The collection can be
    /// generic, that is, the activity type of the items can be specified using the extension 'collection type', but it is
    /// optional.
    /// </summary>
    ...
    /// <summary>
    /// A simulation is an attempted task or series of tasks in an artificial context that mimics reality.  Tasks would likely
    /// take on the form of interactions, or the simulation could be self-contained content.
    /// </summary>
    ...
    /// <summary>
    /// Refers to the answer for a doubt that provides a solution. If the answer is not a solution, it should be coded as
    /// answer, or if it is just a comment, as comment.
    /// </summary>
    ...
    /// <summary>
    /// Used with activities within the Context Activities "category" property of a Statement. Indicates the authoring tool,
    /// template or framework used to create the activity provider. This may help reporting tools to recognise that that data
    /// has come from a particular origin and handle the data correctly based on that information.
    /// </summary>
    ...
    /// <summary>
    /// A step is one of several actions that the actor has to do to achieve something, for instance, a goal or the completion
    /// of a task. For instance, a method, strategy or task could be divided into smaller steps.
    /// </summary>
    ...
    /// <summary>
    /// Activity generally used in the "category" Context Activities lists to mark a statement as being related to a particular
    /// subject area. Distinct from tag in that it is used in conjunction with Category to imply a hierarchy of categorization. 
    /// </summary>
    ...
    /// <summary>
    /// Activity generally used in the "other" or "grouping" Context Activities lists to mark a statement as being related to a
    /// particular subject area. Implemented as a one word identifier used for search filtering or tag cloud generation.
    /// </summary>
    ...
    /// <summary>
    /// Represents an activity that has yet to be completed. Objects of this type can contain additional properties as
    ...
    /// <summary>
    /// A test data batch is an Activity that is used in the Context Activities "category" property of a Statement to indicate
    /// that the Statement is part of a particular collection of test data. The Id of this Activity represents a single
    /// collection of test data e.g. the data generated for a particular test or by a particular tool. 
    /// </summary>
    ...
    /// <summary>
    /// An annotation of the 'underline' type. Underlines are used to mark strings of text in a document with a line underneath
    /// the text. This activity type should only be used for underlined text and not for images or other elements. 
    /// </summary>
    ...
    /// <summary>
    /// Represents video content of any kind. Objects of this type MAY contain additional properties as specified in Section
    /// 3.1.
    /// </summary>
    ...
    /// <summary>
    /// Refers to a word that the learner defines or translates. The vocabulary word can be part of a collection.  that is part
    /// of a vocabulary collection. An actor can use more than one vocabulary collection, for instance, for several languages or
    /// several topics. Besides the “name” (the word)  and a “description” (meaning or translation), we recommend the use of
    /// moreInfo to link to a definition in an online dictionary. As an option, you can use the extension tags to classify the
    /// words.
    /// </summary>
